...
// filepath  : cd /Users/poudel/Copy/Programming/C/cprograms/fitsio/fitsread
// terminal  : clear;gcc fitsread.c -O2 -lcfitsio -lm -pthread;./a.out in.fits
// terminal  : clear;gcc fitsread.c -o fitsread -O2 -lcfitsio -lm -pthread;./fitsread in.fits
