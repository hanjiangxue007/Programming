//topic   : imlist - list pixel values 
...
//terminal: gcc imlist.c -lm -lcfitsio && ./a.out in.fit
//to run  : ./a.out 'in.fit[*:10,*10]'     		// print every 10th pixel
//to run  : ./a.out 'in.fit[20:29,10:19]' 		// print 10x10 section
//to run  : ./a.out 'in.fit[20:29:2,10:19:2]' 	// print every other pixel
        ...
        if (!fits_get_img_param(fptr, 2, &bitpix, &naxis, naxes, &status) )
        {
          ...
          else
          {
            ...
            for (fpixel[1] = naxes[1]; fpixel[1] >= 1; fpixel[1]--)
            {
               ...
               printf(" %4ld ",fpixel[1]);  /* print row number */
