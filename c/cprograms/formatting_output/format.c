...
the square bracket symbol [
    ...
    set of accepted characters; the next pointer must be a pointer to char,
    ...
    character before the final close bracket. For instance, [^]0-9-] 
    means the set "everything except close bracket, zero through nine, 
    and hyphen". The string ends with the appearance of a character not 
