...
int main()
{
	...
	{ 
		printf("Enter the radius in cm\t");		// storing radius and height value in main fn
		scanf (" %lf", &radius);
		printf("Enter the height in cm\t");
		scanf (" %lf", &height);
	
	
		if(choice == 'y' || choice =='Y')		// for cylinder
		{
		comp_volume_cylinder(radius, height);
		comp_area_cylinder(radius, height);
		}
		else if (choice == 'n' || choice =='N')		// for cone
		{
...
//*********************************************************
//now we write fn2: pre: radius,height post: volume_cylinder
double comp_volume_cylinder(double radius, double height)
{
...
//***************************************************
//now we write fn3: pre: radius,height post: area_cylinder
double comp_area_cylinder(double radius, double height)
{
...
//*******************************************************
//now we write fn4: pre: radius,height post: volume_cone
double comp_volume_cone(double radius, double height)
{
	double volume_cone;
