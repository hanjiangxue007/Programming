...
[build-menu]
EX_00_LB=_Execute
EX_00_CM=clear; gfortran -Wall -fbounds-check -Wuninitialized -ffpe-trap=invalid,zero,overflow,underflow -fbacktrace %f && ./a.out && rm a.out
EX_00_WD=
FT_00_LB=_Compile
FT_00_CM=gfortran -Wall -c "%f"
FT_00_WD=
