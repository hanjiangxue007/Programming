...
# Bhishan Poudel
# Jan 12, 2016
# clear; Rscript autosPlot.r  ; rm *~

# inputs: data/autos.dat
# outputs: figures/autos.png

# set the working directory
setwd("~/Copy/Programming/R/rprograms/plotting/2dplots/")

# Start device driver to save output to figure
#png(filename="figures/autosPlot.png", height=295, width=300,  bg="white")
