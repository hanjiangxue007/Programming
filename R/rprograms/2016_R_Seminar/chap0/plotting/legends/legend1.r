...
postscript(file='~/Copy/Programming/R/rprograms/plotting/legends/legend1.eps')
...
for(i in 1:4) {
  ...
  legend("top", legend = LETTERS[1:6], col = c6,
         ncol = 2, cex =~/Copy/Programming/R/rprograms/plotting/legends/legend1.r 2, lwd = 3, text.font = i, text.col = c6)
}
par(op)
