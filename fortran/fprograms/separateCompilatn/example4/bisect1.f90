...
!       make a new c, i.e a =c
      ...
      external function            ! we are using function called function_x
      double precision function    ! intent(in)
...
!
      fleft  = function(left)   ! f(a) value
      fright = function(right)  ! f(b) value
