# clear; gnuplot linetypecolor2.gp; rm *~

set terminal svg size 600,400 dynamic enhanced fname 'arial'  fsize 11 mousing butt dashlength 1.0 
set output 'lines_arrows.1.svg'

#labels
set label 1 "set style line 1 lt 2 lc rgb \"red\" lw 3" \
            at -0.4, -0.25, 0 left norotate back textcolor rgb "red"  nopoint            
set label 2 "set style line 2 lt 2 lc rgb \"orange\" lw 2" \
            at -0.4, -0.35, 0 left norotate back textcolor rgb "orange"  nopoint            
set label 3 "set style line 3 lt 2 lc rgb \"yellow\" lw 3" \
            at -0.4, -0.45, 0 left norotate back textcolor rgb "yellow"  nopoint            
set label 4 "set style line 4 lt 2 lc rgb \"green\" lw 2" \
            at -0.4, -0.55, 0 left norotate back textcolor rgb "green"  nopoint            
