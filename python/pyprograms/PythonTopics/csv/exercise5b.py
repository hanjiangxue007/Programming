...
#   symbol_to_properties out to the file atomic_props_weird.csv
#   using the csv module. In the atomic_props_weird.csv file
#   fields should be separated from each other by a TAB, and
#   the data contained in each field should be preceded and 
#   followed by an asterisk (*), regardless of the type of data
#   in the field.
