...
# clear; python plot_rand_mp.py -o . -n 4

# first mkdir temp then run this command:
# clear; python plot_rand_mp.py -o temp -n 4


# ref: https://philipwfowler.github.io/2015-01-13-oxford/intermediate/python/04-multiprocessing.html
