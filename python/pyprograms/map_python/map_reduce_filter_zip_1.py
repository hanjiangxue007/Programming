...
val1 =  map(lambda a: a+1, [1,2,3,4])
print(val1)     # [2, 3, 4, 5]
val1 = map(lambda a, b: a+b, [1,2,3,4], (2,3,4,5))
print(val1)     #[3, 5, 7, 9]
val1 = map(lambda a, b: a + b if b else a + 10, [1,2,3,4,5], (2,3,4,5))
...
val1 = reduce(lambda x, y: x+y, range(0,10))
print(val1)     # 45 = 9*10/2
val1 = reduce(lambda x, y: x+y, range(0,10), 100)
