...
# Date      : May 23, 2016
# Ref       : http://www.labri.fr/perso/nrougier/teaching/numpy.100/
...
# Create a 3*3 matrix from 0 to 8
Z = np.arange(9).reshape((3,3)).T
print(Z)
...
#Consider a generator function that generates 10 integers and
#use it to build an array
